...
// Cookie SameSite modes Cookie SameSite 模式
const (
...
// Login concurrency scopes 登录并发控制作用域
const (
...
// Non-concurrent login replacement modes 非并发登录替换模式
const (
...
// Token logout state modes Token 下线状态模式
const (
