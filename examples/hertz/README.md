...
这是一个基于当前 `DToken` 项目的 `Hertz` 示例，结构和 `gf/gin` 示例保持一致，包含登录、登录态校验、角色校验、权限校验和注解式校验。
...
- `github.com/Zany2/dtoken-go/integrations/hertz`
...
- 当前版本仍然保持单文件入口，方便快速体验 `Hertz + DToken`
