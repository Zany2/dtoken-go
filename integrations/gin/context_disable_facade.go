...
func CheckDisableByContext(c *gin.Context) error {
...
func DisableServiceByContext(c *gin.Context, service string, duration time.Duration, reason ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func DisableServiceLevelByContext(c *gin.Context, service string, level int, duration time.Duration, reason ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func UntieServiceByContext(c *gin.Context, service string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func IsDisableServiceByContext(c *gin.Context, service string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func IsDisableServiceLevelByContext(c *gin.Context, service string, level int) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func CheckDisableServiceByContext(c *gin.Context, services ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func CheckDisableServiceLevelByContext(c *gin.Context, service string, level int) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GetDisableServiceInfoByContext(c *gin.Context, service string) (*manager.ServiceDisableInfo, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetDisableServiceTTLByContext(c *gin.Context, service string) (int64, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
...
func DisableDeviceByContext(c *gin.Context, device string, duration time.Duration, reason ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func DisableDeviceAndDeviceIDByContext(c *gin.Context, device, deviceId string, duration time.Duration, reason ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func UntieDeviceByContext(c *gin.Context, device string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func UntieDeviceAndDeviceIDByContext(c *gin.Context, device, deviceId string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func IsDisableDeviceByContext(c *gin.Context, device string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func IsDisableDeviceAndDeviceIDByContext(c *gin.Context, device, deviceId string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func CheckDisableDeviceByContext(c *gin.Context, device string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func CheckDisableDeviceAndDeviceIDByContext(c *gin.Context, device, deviceId string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GetDisableDeviceInfoByContext(c *gin.Context, device string) (*manager.DeviceDisableInfo, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetDisableDeviceAndDeviceIDInfoByContext(c *gin.Context, device, deviceId string) (*manager.DeviceDisableInfo, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetDisableDeviceTTLByContext(c *gin.Context, device string) (int64, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
...
func GetDisableDeviceAndDeviceIDTTLByContext(c *gin.Context, device, deviceId string) (int64, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
