...
func RegisterOAuth2ClientByContext(c *gin.Context, client *oauth2.Client) error {
...
func UnregisterOAuth2ClientByContext(c *gin.Context, clientID string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GetOAuth2ClientByContext(c *gin.Context, clientID string) (*oauth2.Client, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2TokenByContext(c *gin.Context, req *oauth2.TokenRequest, validateUser oauth2.UserValidator) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GenerateOAuth2AuthorizationCodeByContext(c *gin.Context, clientID, userID, redirectURI string, scopes []string) (*oauth2.AuthorizationCode, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GenerateOAuth2AuthorizationCodeWithPKCEByContext(c *gin.Context, clientID, userID, redirectURI string, scopes []string, codeChallenge, codeChallengeMethod string) (*oauth2.AuthorizationCode, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ExchangeOAuth2CodeForTokenByContext(c *gin.Context, code, clientID, clientSecret, redirectURI string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ExchangeOAuth2CodeForTokenWithPKCEByContext(c *gin.Context, code, clientID, clientSecret, redirectURI, codeVerifier string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2ClientCredentialsTokenByContext(c *gin.Context, clientID, clientSecret string, scopes []string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2PasswordGrantTokenByContext(c *gin.Context, clientID, clientSecret, username, password string, scopes []string, validateUser oauth2.UserValidator) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func RefreshOAuth2AccessTokenByContext(c *gin.Context, clientID, refreshToken, clientSecret string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ValidateOAuth2AccessTokenByContext(c *gin.Context, accessToken string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func ValidateOAuth2AccessTokenAndGetInfoByContext(c *gin.Context, accessToken string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func RevokeOAuth2TokenByContext(c *gin.Context, accessToken string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
