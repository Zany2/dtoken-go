...
// DToken manager operations. DToken 管理器相关操作。
var (
...
// DToken login and token operations. DToken 登录与 Token 相关操作。
var (
	Login                                     = dtoken.Login
...
// DToken disable operations. DToken 封禁相关操作。
var (
...
// DToken permission operations. DToken 权限相关操作。
var (
...
// DToken role operations. DToken 角色相关操作。
var (
...
// DToken nonce operations. DToken nonce 相关操作。
var (
...
// DToken OAuth2 operations. DToken OAuth2 相关操作。
var (
