...
// GetTokenValueByContext gets token value from current Echo context GetTokenValueByContext 从当前 Echo 上下文获取 Token。
...
func GetLoginIDByContext(c echo4.Context) (string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return "", err
	}
...
func LogoutByContext(c echo4.Context) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func KickoutByContext(c echo4.Context) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func ReplaceByContext(c echo4.Context) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GetTokenInfoByContext(c echo4.Context) (*manager.TokenInfo, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetDeviceByContext(c echo4.Context) (string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return "", err
	}
...
func GetDeviceIDByContext(c echo4.Context) (string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return "", err
	}
...
func GetTokenCreateTimeByContext(c echo4.Context) (int64, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
...
func GetSessionByContext(c echo4.Context) (*manager.Session, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetSessionByTokenByContext(c echo4.Context) (*manager.Session, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetTokenValueListByContext(c echo4.Context, checkAlive ...bool) ([]string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetOnlineTerminalCountByContext(c echo4.Context) (int, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
...
func GetRolesByContext(c echo4.Context) ([]string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetRolesByTokenByContext(c echo4.Context) ([]string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func HasRolesByContext(c echo4.Context, roles []string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func HasRolesOrByContext(c echo4.Context, roles []string) bool {
...
func GetPermissionsByContext(c echo4.Context) ([]string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetPermissionsByTokenByContext(c echo4.Context) ([]string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func HasPermissionsByContext(c echo4.Context, permissions []string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func HasPermissionsOrByContext(c echo4.Context, permissions []string) bool {
...
func IsDisableByContext(c echo4.Context) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func GetDisableInfoByContext(c echo4.Context) (*manager.DisableInfo, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GetDisableTTLByContext(c echo4.Context) (int64, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return 0, err
	}
...
func DisableByContext(c echo4.Context, duration time.Duration, reason ...string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func UntieByContext(c echo4.Context) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GenerateNonceByContext(c echo4.Context) (string, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return "", err
	}
...
func VerifyAndConsumeNonceByContext(c echo4.Context, nonce string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
