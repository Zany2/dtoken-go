...
func RegisterOAuth2ClientByContext(c echo4.Context, client *oauth2.Client) error {
...
func UnregisterOAuth2ClientByContext(c echo4.Context, clientID string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
...
func GetOAuth2ClientByContext(c echo4.Context, clientID string) (*oauth2.Client, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2TokenByContext(c echo4.Context, req *oauth2.TokenRequest, validateUser oauth2.UserValidator) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GenerateOAuth2AuthorizationCodeByContext(c echo4.Context, clientID, userID, redirectURI string, scopes []string) (*oauth2.AuthorizationCode, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func GenerateOAuth2AuthorizationCodeWithPKCEByContext(c echo4.Context, clientID, userID, redirectURI string, scopes []string, codeChallenge, codeChallengeMethod string) (*oauth2.AuthorizationCode, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ExchangeOAuth2CodeForTokenByContext(c echo4.Context, code, clientID, clientSecret, redirectURI string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ExchangeOAuth2CodeForTokenWithPKCEByContext(c echo4.Context, code, clientID, clientSecret, redirectURI, codeVerifier string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2ClientCredentialsTokenByContext(c echo4.Context, clientID, clientSecret string, scopes []string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func OAuth2PasswordGrantTokenByContext(c echo4.Context, clientID, clientSecret, username, password string, scopes []string, validateUser oauth2.UserValidator) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func RefreshOAuth2AccessTokenByContext(c echo4.Context, clientID, refreshToken, clientSecret string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func ValidateOAuth2AccessTokenByContext(c echo4.Context, accessToken string) bool {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return false
	}
...
func ValidateOAuth2AccessTokenAndGetInfoByContext(c echo4.Context, accessToken string) (*oauth2.AccessToken, error) {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return nil, err
	}
...
func RevokeOAuth2TokenByContext(c echo4.Context, accessToken string) error {
	dCtx, err := requireDTokenContextByContext(c)
	if err != nil {
		return err
	}
