...
[English](../integration/component-ecosystem.md) | 中文文档
...
Redis 接入方式见 [Redis 存储](../integration/redis-storage_zh.md)。
...
更多风格说明见 [Token 风格](../core/token-style_zh.md)。
